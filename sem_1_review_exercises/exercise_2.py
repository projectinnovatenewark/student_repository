""" 
  ...
  9_basic_math,
  10_imports,
  11_functions_and_scope,
  Workshop_2: Pseudocode
"""
...
# the value of its area. Then create a seperate function called "printer()" that calls "findArea()"
# and prints its return value in the statement, "The area of the new circle is [area]." The radius
# should again be passed as an argument to the "findArea()" function.
