...
# TODO: convert things in Python. The first type conversion funciton we will use is str(). 
# TODO: Try the statement from Section 3 instructed of using plus signs to concatenate strings to 
