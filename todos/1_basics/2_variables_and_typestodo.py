"""
Enjoy your first Todo assignment! This correlates to Lesson 2, so feel free to check 
the lesson to help you thoughout the assignemnt.
"""

# TODO: Section 1:
# Set a variable 'phrase1' equal to "Hi everyone! " and another variable 'phrase2'
# equal to "My name is ____" (complete with your name). Then use what you learned so
...
# integers, floats, booleans, stings, and None types. Set one variable for each
# of those types (i.e. exampleInt = 0, exampleBool = False, etc.).
# Create a print statement that would print the type of each variable you've set.
...
# Using the statement from Section 3, print `My name is _____ and I am ______ years old.` 
# using concatenation (plus signs) to work with the name and age variables. Use type conversion
# to convert the variable 'age' into a string. The print statement will no longer throw an
