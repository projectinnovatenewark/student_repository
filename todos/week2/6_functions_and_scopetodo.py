...
# TODO: create a function that takes a dictionary as an argument, loops through the
# TODO: dictionary, then returns the iteration number, key, and value in a readable way
